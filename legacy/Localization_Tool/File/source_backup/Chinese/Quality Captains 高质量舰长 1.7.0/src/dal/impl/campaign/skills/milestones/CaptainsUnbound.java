...
public class CaptainsUnbound {
	...
	public static final String skillName = "无界";
	public static final String skillDesc = "当所有门户洞开、众人之耳聆听乐声。";
	public static final String skillAuthor = "布道 - '在预言中'";
	...
	public static class Level1 implements FleetStatsSkillEffect {
		...
		public String getEffectDescription(float level) {
			if (enabled) return "你的舰队能侦测到附近星系中的星门。";
			return "";
		}
		...
		for (SkillLevelAPI skill : Global.getSector().getPlayerStats().getSkillsCopy()) {
			if (skill.getSkill().getId().equals(skillID)) {
				if (skill.getLevel()==0) {
					...
					skill.getSkill().setDescription("实现前人未竟之梦。");
