...
public class CaptainsPhaseMastery {
	...
	public static class Level1 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "-" + (int)(FLUX_UPKEEP_REDUCTION) + "% 激活相位隐形所产生的幅能";
		}
	...
	public static class Level3 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(PHASE_SPEED_BONUS_FRIG) + "/" + (int)(PHASE_SPEED_BONUS_DEST) + "/" + (int)(PHASE_SPEED_BONUS_CRU) + "/" + (int)(PHASE_SPEED_BONUS_CAP) + "% 相位隐形激活时的最高航速，根据船体等级从小到大";
		}
