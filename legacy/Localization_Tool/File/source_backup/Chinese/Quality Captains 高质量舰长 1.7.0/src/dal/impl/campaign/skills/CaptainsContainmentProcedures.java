...
public class CaptainsContainmentProcedures {
	...
	public static class Level4 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "-" + FUEL_USE_REDUCTION_PERC + "% 燃料消耗，+" + FUEL_SALVAGE_BONUS + "% 打捞到的燃料";
		}
	...
	public static class Level1 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "-" + (int)(CREW_LOSS_REDUCTION_COMBAT) + "% 战斗中人员伤亡，-" + (int)(CREW_LOSS_REDUCTION_NON_COMBAT) + "% 非战斗行动人员伤亡";
		}
	...
	public static class Level3B implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "-" + (int) Math.round((100f - CORONA_EFFECT_PERC_MULT)) + "% 因恒星日冕或类似环境造成的战备值 (CR) 损失";
		}
