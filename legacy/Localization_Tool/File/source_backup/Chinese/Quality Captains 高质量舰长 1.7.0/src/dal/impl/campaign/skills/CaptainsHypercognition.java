...
public class CaptainsHypercognition {
	...
	public static class Level1 implements MarketSkillEffect {
		public void apply(MarketAPI market, String id, float level) {
			market.getAccessibilityMod().modifyFlat(id, ACCESS, "超越认知");
		}
		...
		public String getEffectDescription(float level) {
			return "+" + (int)Math.round(ACCESS * 100f) + "% 流通性";
		}
	...
	public static class Level2 implements MarketSkillEffect {
		public void apply(MarketAPI market, String id, float level) {
			market.getStats().getDynamic().getMod(Stats.COMBAT_FLEET_SIZE_MULT).modifyFlat(id, FLEET_SIZE / 100f, "超越认知");
		}
		...
		public String getEffectDescription(float level) {
			...
			return "+" + (int)Math.round(FLEET_SIZE) + "% 舰队规模";
		}
	...
	public static class Level3 implements MarketSkillEffect {
		public void apply(MarketAPI market, String id, float level) {
			market.getStats().getDynamic().getMod(Stats.GROUND_DEFENSES_MOD).modifyMult(id, 1f + DEFEND_BONUS * 0.01f, "超越认知");
		}
	...
	public static class Level4 implements MarketSkillEffect {
		public void apply(MarketAPI market, String id, float level) {
			market.getStability().modifyFlat(id, STABILITY_BONUS, "超越认知");
		}
		...
		public String getEffectDescription(float level) {
			return "+" + (int)STABILITY_BONUS + " 稳定度";
		}
