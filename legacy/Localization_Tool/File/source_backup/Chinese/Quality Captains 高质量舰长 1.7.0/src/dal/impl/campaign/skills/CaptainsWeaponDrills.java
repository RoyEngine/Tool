...
public class CaptainsWeaponDrills {
	...
	public static class Level1 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "-" + (int)(WEAPON_RECOIL_NEG_PERC) + "% 武器后坐力";
		}
	...
	public static class Level2 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(TURRET_LEADING_PERC) + "% 自动开火武器精度";
		}
	...
	public static class Level3 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(WEAPON_REPAIR_BONUS) + "% 战斗中武器修理速度";
		}
	...
	public static class Level4 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)WEAPON_ROF_BONUS + "% 实弹与能量武器射速";
	...
	public static class Level1f extends BaseSkillEffectDescription implements ShipSkillEffect, FleetTotalSource {
		...
		public void createCustomDescription(MutableCharacterStatsAPI stats, SkillSpecAPI skill, 
			...
			info.addPara("+%s 作战舰船武器伤害 (上限: %s)", 0f, hc, hc,
					"" + (int) damBonus + "%",
					"" + (int) DAMAGE_PERCENT + "%");
