...
//			}
	...
	public static class Level2 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			if (USE_SEX_BONUS) {
				return "未指派军官的舰船获得 " + (int)(CaptainsSystemsExpertise.NO_OFFICER_FACTOR * 100f) + "% 强度的基础 系统专长 技能";
			}
			return "";
		}
	...
	public static class Level3 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			...
			return "未指派军官的舰船获得 " + (int)(CaptainsGunneryImplants.GEN_SKILL_MULT * 100f) + "% 强度的基础 火控植入 技能";
		}
