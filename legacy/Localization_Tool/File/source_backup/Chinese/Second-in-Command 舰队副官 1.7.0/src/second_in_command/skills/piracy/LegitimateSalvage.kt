...
class LegitimateSalvage : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+15%% 敌舰击沉后武器掉落概率", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+30%% 勘探废弃空间站等遗迹设施时获得的资源 - 不包括蓝图等稀有物品", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
