...
class MagneticShielding : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("免疫恒星星冕及其他类似危险环境造成的伤害", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+25%% EMP 效果抵抗", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
    }
