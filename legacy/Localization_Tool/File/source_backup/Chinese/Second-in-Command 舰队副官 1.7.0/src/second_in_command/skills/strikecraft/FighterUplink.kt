...
class FighterUplink : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("-50%% 因战机被击落而导致的人员伤亡", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+50%% 投弹精度", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+10%% 最高航速", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
