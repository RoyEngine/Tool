...
class StablisedTargeting : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+10%% 实弹武器伤害", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+20%% 弹体飞行速率", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("-25%% 武器后坐力", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
