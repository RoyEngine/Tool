...
class SafeRecovery : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        tooltip.addPara("+30%% 主动排幅时装甲和船体的伤害抗性", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+30%% 主动排幅速率", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
    }
