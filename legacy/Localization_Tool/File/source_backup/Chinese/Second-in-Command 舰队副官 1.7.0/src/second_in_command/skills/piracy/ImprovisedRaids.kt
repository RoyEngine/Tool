...
class ImprovisedRaids : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+40%% 突袭等地面行动的效果", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
    ...
    override fun advance(data: SCData, amount: Float) {
        data.fleet.stats.dynamic.getMod(Stats.PLANETARY_OPERATIONS_MOD).modifyPercent("sc_improvised_raids", 40f, "临机突袭")
