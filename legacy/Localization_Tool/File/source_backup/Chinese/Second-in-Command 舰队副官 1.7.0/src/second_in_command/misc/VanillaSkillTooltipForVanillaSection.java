...
public class VanillaSkillTooltipForVanillaSection extends BaseTooltipCreator {
    ...
    public String getAffectsString(SkillSpecAPI skill) {
        ...
        return switch (skill.getScope()) {
            case PILOTED_SHIP -> "座舰";
            case ALL_SHIPS -> "所有舰船";
            case ALL_COMBAT_SHIPS -> "所有战斗舰船";
            case ALL_CARRIERS -> "所有航母";
            case ALL_FIGHTERS -> "所有战机";
            case SHIP_FIGHTERS -> "战机";
            case GOVERNED_OUTPOST -> "管理的殖民地";
            case ALL_OUTPOSTS -> "所有殖民地";
            case FLEET -> "舰队";
            case CUSTOM -> "自定义";
            case NONE -> "无";
        };
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, Object tooltipParam) {
       ...
       // tooltip.setParaFont(Fonts.DEFAULT_SMALL);
        ...
        if (affects != null) {
            tooltip.addPara("影响：" + affects, 0f, Misc.getGrayColor(), Misc.getBasePlayerColor(), affects);
            tooltip.addSpacer(10f);
        }
        ...
        for (HullModSpecAPI hullmodSpec: hullmodSpecs) {
            tooltip.addPara("舰船插件：" + hullmodSpec.getDisplayName() + " - " + ReflectionUtils.invoke("getShortDesc", hullmodSpec, new Array[]{}, null, null) , 0f,
