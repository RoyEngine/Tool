...
class AdvancedManeuvers : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+10%% 造成的伤害", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+15%% 武器射速", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+50%% 目标瞄准精度", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
