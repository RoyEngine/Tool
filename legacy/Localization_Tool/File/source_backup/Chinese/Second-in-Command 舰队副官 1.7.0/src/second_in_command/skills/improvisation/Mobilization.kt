...
class Mobilization : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("-25%% 民用与军用舰船的燃料消耗量减少。", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("安装有 \"军事化子系统\" 船插的舰船获得以下增益：", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - +10%% 最高航速", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "+10%")
        tooltip.addPara("   - +10%% 幅能耗散和幅能容量", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "+10%")
        tooltip.addPara("   - +15%% 武器射程", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "+15%")
