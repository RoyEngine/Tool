...
class PrepareForTheWorst : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+10%% 所有舰船 战备值 (CR) 上限", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+30%% 战斗外的维修速率", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+4%% 每天的战备值固定回复速率", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
    ...
    override fun applyEffectsBeforeShipCreation(data: SCData, stats: MutableShipStatsAPI, variant: ShipVariantAPI, hullSize: ShipAPI.HullSize?, id: String?) {
        ...
        stats.maxCombatReadiness.modifyFlat(id, cr, "有备无患")
