...
public class CaptainsMissileSpecialization {
	...
	public static class Level1 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(MISSILE_AMMO_BONUS_1) + "% 导弹武器备弹量";
		}
	...
	public static class Level1B implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(MISSILE_AMMO_BONUS_2) + "% 导弹武器额外备弹量";
		}
	...
	public static class Level2 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			...
			return "+" + (int)(MISSILE_SPEC_HEALTH_BONUS) + "% 武器投射物耐久度";
		}
	...
	public static class Level3 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(MISSILE_SPEC_ROF_BONUS) + "% 导弹武器射速";
		}
	...
	public static class Level4 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(MISSILE_TURN_RATE_BONUS) + "% 导弹机动性";
		}
