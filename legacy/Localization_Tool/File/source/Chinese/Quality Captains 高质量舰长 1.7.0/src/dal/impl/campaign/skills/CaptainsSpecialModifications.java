...
public class CaptainsSpecialModifications {
	...
	public static class Level1 implements CharacterStatsSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int) CAPACITORS_BONUS + " 幅能寄存器上限";
		}
	...
	public static class Level3 implements CharacterStatsSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int) Math.round(BUILD_IN_XP_BONUS * 100f) + "% 内置* 舰船插件后所获得的额外经验";
		}
	...
	public static class Level4 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + EXTRA_SMODS + " 个最大可 内置* 舰船插件数";
		}
	...
	public static class Level5 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + EXTRA_LMODS + " 个最大可 内置 后勤船插数";
		}
