...
public class CaptainsPointDefense {
	...
	public static class Level1 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(FIGHTER_DAMAGE_BONUS) + "% 对战机的伤害，舰船部署的战机享受 1/" + Math.round(1/FIGHTER_DAMAGE_BONUS_FTR_MULT) + " 的增益。";
		}
	...
	public static class Level2 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(MISSILE_DAMAGE_BONUS) + "% 对导弹的伤害，舰船部署的战机享受 1/" + Math.round(1/MISSILE_DAMAGE_BONUS_FTR_MULT) + " 的增益。";
		}
	...
	public static class Level3 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			...
			return "+" + (int)(PD_RANGE_BONUS_FLAT) + " 点防御武器的射程";
		}
	...
	public static class Level4 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(TURRET_TURN_BONUS) + "% 武器炮塔转速";
		}
