...
public class CaptainsOrdnanceExpertise {
	...
	public static class Level1 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			if (!USE_DISCOUNT_EFFECT) {
				return "每在武器上花费一个装配点，+" + Misc.getRoundedValueMaxOneAfterDecimal(FLUX_PER_OP) + " 点 幅能耗散";
			}
			return "每在武器上花费一个装配点，-" + FLUX_GEN_REDUCTION_PER_OP_FRIG + " / " + FLUX_GEN_REDUCTION_PER_OP_DEST + " / "  + FLUX_GEN_REDUCTION_PER_OP_CRSR + " / "  + FLUX_GEN_REDUCTION_PER_OP_CAPITAL + "% 武器产生的幅能，\n 根据船体等级，最多 -" + Math.round(FLUX_GEN_REDUCTION_CAP) + "%";
		}
	...
	public static class Level2 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "每在武器上花费一个装配点，+" + (int)(CAP_PER_OP) + " 点 幅能容量";
		}
