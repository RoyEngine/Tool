...
public class CaptainsStarfarer { //Sentinel
	...
	public static final String skillName = "星旅者";
	public static final String skillDesc = "再见，太空牛仔。";
	public static final String skillAuthor = "一位高质量舰长";
	...
	public static class Level1 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			if (enabled) return "你是英仙座星域活着的传奇。你的英勇事迹在每家酒馆和所有权力殿堂中广为传颂。\n你以每个月 " + SP_BONUS + " 的速率被动获得额外的故事点。";
			return "";
		}
		...
		for (SkillLevelAPI skill : Global.getSector().getPlayerStats().getSkillsCopy()) {
			if (skill.getSkill().getId().equals(skillID)) {
				if (skill.getLevel()==0) {
					...
					skill.getSkill().setDescription("当每条道路都抵达尽头。");
