...
//	public static final float MISSILE_RANGE_MULT = 0.8f;
	...
	public static class Level4 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(TARGET_LEADING_BONUS) + "% 目标追踪精度";
		}
	...
	public static class Level3 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			...
			*/
			...
			+ Math.round(FTR_DAMAGE_TO_CAPITALS) + "% 对目标的伤害，基于其船体等级";
			return desc;
		}
...
//	}
	...
	public static class Level1 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(SPEED_BONUS) + "% 最高航速与机动性";
		}
	...
	public static class Level2 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "+" + (int)(MISSILE_HITPOINTS_BONUS) + "% 导弹、火箭弹、炸弹和鱼雷的耐久度";
		}
	...
	*/
	...
	public static class Level5 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "" + (int)(FIGHTER_REPLACEMENT_RATE_BONUS) + "% 战机整备速度";
		}
	...
	public static class Level6 implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "-" + (int)(DAMAGE_TAKEN_REDUCTION) + "% 受到的伤害";
		}
