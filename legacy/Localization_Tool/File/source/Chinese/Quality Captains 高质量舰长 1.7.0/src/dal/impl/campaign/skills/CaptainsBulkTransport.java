...
//			}
	...
	public static class Market1 implements MarketSkillEffect {
		public void apply(MarketAPI market, String id, float level) {
			if (level == 1) {
				market.getAccessibilityMod().modifyFlat(id, ACCESS_BONUS_1, "舰队后勤");
			} else if (level > 1) {
				market.getAccessibilityMod().modifyFlat(id, ACCESS_BONUS_1 + ACCESS_BONUS_2, "舰队后勤");
			}
		}
		...
		public String getEffectDescription(float level) {
			return "+" + (int)Math.round(ACCESS_BONUS_1) + "% 管理的殖民地流通性";
		}
	...
	public static class Market2 implements MarketSkillEffect {
		public void apply(MarketAPI market, String id, float level) {
			//market.getAccessibilityMod().modifyFlat(id, ACCESS_2, "舰队后勤");
		}
		...
		public String getEffectDescription(float level) {
			return "+" + (int)Math.round(ACCESS_BONUS_2) + "% 管理的殖民地流通性";
		}
	...
	public static class Market3 implements MarketSkillEffect {
		public void apply(MarketAPI market, String id, float level) {
			market.getStats().getDynamic().getMod(Stats.COMBAT_FLEET_SIZE_MULT).modifyFlat(id, FLEET_SIZE_BONUS / 100f, "舰队后勤");
		}
		...
		public String getEffectDescription(float level) {
			return "+" + (int)Math.round(FLEET_SIZE_BONUS) + "% 管理的殖民地舰队规模";
		}
