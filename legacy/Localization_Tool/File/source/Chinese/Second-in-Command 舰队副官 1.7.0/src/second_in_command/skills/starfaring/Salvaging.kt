...
class Salvaging : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+50%% 勘探废弃空间站等遗迹设施时获得的资源 - 不包括蓝图等稀有物品", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+20%% 战后物品打捞量", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("-75%% 非战斗行动造成的人员伤亡", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
    ...
    override fun advance(data: SCData, amount: Float) {
        ...
        data.fleet.stats.dynamic.getStat(Stats.SALVAGE_VALUE_MULT_FLEET_NOT_RARE).modifyFlat("sc_salvaging", 0.5f, "打捞作业")
        data.fleet.stats.dynamic.getStat(Stats.BATTLE_SALVAGE_MULT_FLEET).modifyFlat("sc_salvaging", 0.2f, "打捞作业")
    }
