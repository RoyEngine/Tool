...
class Navigation : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+1 \"持续加速\" 能力带来的航速增益", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("-30%% 特殊地形的移动速度惩罚", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
    ...
    override fun advance(data: SCData, amount: Float) {
        ...
        data.fleet.stats.fleetwideMaxBurnMod.modifyFlat("sc_navigation", 1f, "精准导航")
        data.fleet.stats.dynamic.getMod(Stats.SUSTAINED_BURN_BONUS).modifyFlat("sc_navigation", 1f, "精准导航")
    }
