...
class Authority : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("每占领一个目标点 +3%% 最高航速和机动性", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("每占领一个目标点 +3%% 所有武器射程", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
