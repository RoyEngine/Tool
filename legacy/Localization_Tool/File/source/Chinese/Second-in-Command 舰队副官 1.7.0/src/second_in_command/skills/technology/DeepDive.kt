...
class DeepDive : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+20%% 相位舰船峰值时间", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("相位隐形中的时间流速增益提升至 400%%", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - 标准相位系统基础时间流速增益为 300%%", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "300%")
