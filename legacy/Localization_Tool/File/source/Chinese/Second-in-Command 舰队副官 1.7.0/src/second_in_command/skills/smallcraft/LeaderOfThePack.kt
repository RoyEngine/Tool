...
class LeaderOfThePack : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        tooltip.addPara("当护卫舰和驱逐舰靠近指派有军官的巡洋舰或主力舰时，护卫舰和驱逐舰获得增益效果", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - 本效果生效半径约为 1000",0f, Misc.getTextColor(), Misc.getHighlightColor(), "1000")
        tooltip.addPara("   - 受到影响的舰船 +15%% 所有伤害抗性",0f, Misc.getTextColor(), Misc.getHighlightColor(), "+15%")
        tooltip.addPara("   - 受到影响的舰船 +10%% 所有武器射程",0f, Misc.getTextColor(), Misc.getHighlightColor(), "+10%")
