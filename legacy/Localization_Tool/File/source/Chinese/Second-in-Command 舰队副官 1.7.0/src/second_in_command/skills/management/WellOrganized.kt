...
class WellOrganized : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        tooltip.addPara("你更容易在殖民地找到军官", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("-33%% 所有舰船的必要船员需求", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("-33%% 战斗中的船员伤亡", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
    }
