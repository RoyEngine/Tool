...
class PristineCondition : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("战斗中损失的舰船有 20%% 的概率避免产生 D-插件", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("每拥有一个内置船插，+5%% 战备值 (CR) 上限 (上限 15%%)", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
    ...
    override fun applyEffectsBeforeShipCreation(data: SCData, stats: MutableShipStatsAPI?, variant: ShipVariantAPI, hullSize: ShipAPI.HullSize?, id: String?) {
        ...
        stats!!.maxCombatReadiness.modifyFlat(id, bonus, "精益求精")
