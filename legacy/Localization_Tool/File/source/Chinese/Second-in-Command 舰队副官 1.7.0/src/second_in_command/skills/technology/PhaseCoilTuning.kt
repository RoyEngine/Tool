...
class PhaseCoilTuning : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+120 秒 相位舰船峰值时间", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+30%% 相位隐形下的最高航速与加速度", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+50%% 相位舰船的传感器探测强度", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
