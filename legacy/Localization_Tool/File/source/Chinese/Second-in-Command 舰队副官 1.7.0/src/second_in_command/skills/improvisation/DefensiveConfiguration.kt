...
class DefensiveConfiguration : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+100 点防御武器射程", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+33%% 武器转向速度", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
