...
*/
        ...
        tooltip.addPara("所有指派有军官的舰船获得以下增益: ", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - +5%% 战备值 (CR) 上限", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "+5%")
        tooltip.addPara("   - +20%% 性能峰值时间", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "+20%")
        tooltip.addPara("   - -20%% 舰船恢复成本", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "-20%")
    ...
    override fun applyEffectsBeforeShipCreation(data: SCData, stats: MutableShipStatsAPI?, variant: ShipVariantAPI, hullSize: ShipAPI.HullSize?, id: String?) {
        ...
        if (captain != null && !captain.isDefault) {
            stats.maxCombatReadiness.modifyFlat(id, 0.05f, "军官管理")
