...
class LimitBreaker : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("所有 AI 核心等级提升 1", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - 如果该执行军官被撤销指派，则退回默认等级", 0f, Misc.getTextColor(), Misc.getHighlightColor())
        tooltip.addPara("   - 如果核心具备的技能比当前等级上限更多，会自动使其失效", 0f, Misc.getTextColor(), Misc.getHighlightColor())
    }
