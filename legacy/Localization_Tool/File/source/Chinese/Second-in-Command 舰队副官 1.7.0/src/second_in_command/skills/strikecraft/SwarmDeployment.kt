...
class SwarmDeployment : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("包含至少 4 架战机的战机联队额外增加 1 架战机", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - 该技能可能不适用于搭载{后备部署 }或其他同类战术系统的舰船", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "后备部署")
