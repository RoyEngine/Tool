...
class ReinforcedGrid : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("-40%% 过载持续时间", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("+25%% EMP 效果抗性", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
