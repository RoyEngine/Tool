...
class CrewTraining : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+15%% 战备值 (CR) 上限", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - 所有指派有军官的舰船，额外 +5%%", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "+5%")
...
*/
    ...
    override fun applyEffectsBeforeShipCreation(data: SCData, stats: MutableShipStatsAPI?, variant: ShipVariantAPI, hullSize: ShipAPI.HullSize?, id: String?) {
       ...
       /* var captain = stats!!.fleetMember?.captain
        ...
        stats!!.maxCombatReadiness.modifyFlat("sc_crew_training", cr, "船员培训")
