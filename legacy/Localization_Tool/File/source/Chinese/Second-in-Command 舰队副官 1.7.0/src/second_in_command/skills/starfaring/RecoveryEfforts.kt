...
class RecoveryEfforts : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("+40%% 战斗外的维修速率", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("战斗结束后，免费修复 25%% 的船体结构和装甲损伤", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
