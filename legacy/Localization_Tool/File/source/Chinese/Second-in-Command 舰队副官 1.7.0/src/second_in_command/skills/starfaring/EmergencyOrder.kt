...
class EmergencyOrder : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("\"横轴跳跃\" 和 \"紧急加速\" 能力不再降低战备值 (CR)", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("-20%% 危险环境造成的伤害，比如超空间风暴和恒星耀斑", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
