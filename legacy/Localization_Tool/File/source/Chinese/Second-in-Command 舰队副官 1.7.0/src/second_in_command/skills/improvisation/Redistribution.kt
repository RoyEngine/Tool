...
class Redistribution : SCBaseSkillPlugin() {
    ...
    override fun addTooltip(data: SCData, tooltip: TooltipMakerAPI) {
        ...
        tooltip.addPara("安装有 \"护盾分流\" 船插的舰船获得以下增益: ", 0f, Misc.getHighlightColor(), Misc.getHighlightColor())
        tooltip.addPara("   - +5%% 幅能耗散", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "+5%")
        tooltip.addPara("   - +10%% 装甲", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "+10%")
        tooltip.addPara("   - -20%% 受到的 EMP 效果", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "-20%")
